...
class NurseListView extends ConsumerWidget {
  const NurseListView({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return MyUI(
      ...
      child: ClipRRect(
        ...
        child: Scaffold(
          appBar: AppBar(title: Text('List Staff & Perawat'), centerTitle: true),
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: ListNurseLayout(
                                item: item,
                                onSelected: () => context.goto(page: NurseDetailView(item)),
                              ),
                            );
                          },
