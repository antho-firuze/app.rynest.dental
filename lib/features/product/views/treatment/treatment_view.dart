...
import 'package:dental/features/product/views/treatment/teeth_view.dart';
                    ...
                    children: [
                      Card(
                        child: ListTile(
                          ...
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.bleaching)),
                        ),
                      ),
                      5.height,
                      Card(
                        child: ListTile(
                          ...
                          trailing: const Icon(SuperIcons.mg_right_line),
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.scaling)),
                        ),
                      ),
                      5.height,
                      Card(
                        child: ListTile(
                          ...
                          trailing: const Icon(SuperIcons.mg_right_line),
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.veneer)),
                        ),
                      ),
                      5.height,
                      Card(
                        child: ListTile(
                          ...
                          trailing: const Icon(SuperIcons.mg_right_line),
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.filling)),
                        ),
                      ),
                      5.height,
                      Card(
                        child: ListTile(
                          ...
                          trailing: const Icon(SuperIcons.mg_right_line),
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.rct)),
                        ),
                      ),
                      5.height,
                      Card(
                        child: ListTile(
                          ...
                          trailing: const Icon(SuperIcons.mg_right_line),
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.braces)),
                        ),
                      ),
                      5.height,
                      Card(
                        child: ListTile(
                          ...
                          trailing: const Icon(SuperIcons.mg_right_line),
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.cnb)),
                        ),
                      ),
                      5.height,
                      Card(
                        child: ListTile(
                          ...
                          trailing: const Icon(SuperIcons.mg_right_line),
                          onTap: () async => await context.goto(page: const TeethView(TreatmentType.jewelry)),
                        ),
                      ),
                    ],
                  ),
